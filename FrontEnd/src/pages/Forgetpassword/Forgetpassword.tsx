...
export default function Forgetpassword() {
  ...
  const { register, handleSubmit } = useForm<FormData>({ resolver: yupResolver(forgetpasswordSchema) })
  ...
  return (
    <div className='w-full bg-gradient-to-tl from-yellow to-blue'>
              ...
              <form className='p-10 rounded bg-white shadow-sm' onSubmit={handleSubmit(onSubmit)} noValidate>
                ...
                <div className='mt-1'>
                  <button
                    ...
                    className='w-full text-center py-4 px-2 uppercase rounded bg-blue text-white text-sm hover:bg-blue'
                  >
                    Send
                  </button>
                </div>
