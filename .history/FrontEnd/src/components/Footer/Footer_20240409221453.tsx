            ...
            <div className='flex-grow-1 '>
              <div className=' mb-6'>
                <Link to='/' className='logo-wrapper'>
                  <img src={logo1} alt='logo' className='w-[360px] h-[120px]' />
                </Link>
              </div>
              <div className='mb-6'>
                <div className='mt-3'>
              ...
              <div className='flex flex-col gap-4'>
                <div className='flex flex-col gap-5'>
                  ...
                  <div className='flex gap-4 text-white text-3xl '>
                    <Link to='/'>
                      <FaFacebookF className='hover:text-cyan-700 border rounded-full border-white p-[6px]' />
                    </Link>
                    <Link to='/'>
                      <FaTwitter className='hover:text-cyan-700 border rounded-full border-white p-[6px]' />
                    </Link>
                    <Link to='/'>
                      <IoLogoGoogle className='hover:text-cyan-700 border rounded-full border-white p-[6px]' />
                    </Link>
                    <Link to='/'>
                      <PiInstagramLogoBold className='hover:text-cyan-700 border rounded-full border-white p-[6px]' />
                    </Link>
                    <Link to='/'>
                      <IoLogoYoutube className='hover:text-cyan-700 border rounded-full border-white p-[6px]' />
                    </Link>
                  </div>
                </div>
