        ...
        <div className='p-[20px] mx-auto'>
          <div className='flex gap-12 text-black'>
            <div className='flex-grow-1 '>
              ...
              <div className=''>
                <span>Chúng tôi ở đây vì sức khỏe của bạn</span>
              </div>
            </div>
            <div className='flex-grow-1'>
              <span className='font-semibold text-black'>Bạn cần hỗ trợ</span>
              <div className='mb-6'>
                <div className='mt-3'>
                  <ul className='flex flex-col gap-3'>
                    <li>Địa chỉ: Phường Hòa Khánh Bắc, Quận Liên Chiểu, T.Phố Đà Nẵng</li>
                    <li>
                      Hotline:{' '}
