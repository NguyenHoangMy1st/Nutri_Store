...
import logo1 from "FrontEnd\src\assets\images\logo1.png"
    ...
    <div className='pb-5 pt-2 bg-gradient-to-b from-[#1CA7EC] to-[#4ADEDE] text-white '>
      <div className='container mx-3'>
        <div className='grid grid-cols-12 gap-3 mt-4 items-center'>
          <Link to='/' className='col-span-3 ml-3'>
            <div className='flex text-4xl items-center justify-items-center gap-1 font-extrabold'>
              <img src={logo1} alt='' className='w-12 h-12 items-center justify-items-center mr-2 rounded-full ' />
            ...
            {/* <div className='relative max-w-[400px] rounded-sm border border-gray-200 bg-white text-sm shadow-md'>
              <div className='p-2'>
                ...
                <div className='mt-6 flex items-center justify-between'>
                  ...
                  <Link to='/' className='rounded-sm bg-[#1CA7EC] px-4 py-2 capitalize text-white hover:bg-opacity-90'>
                    View
                  </Link>
                </div>
              </div> */}
